...
// If name is the exact match as Mary, then we console.log, "Hi, Mary!"
// If the name is is not Mary, we console.log, "How do you do?"
...
// If the code is the exact match of 123, then secret is super and code is code *2
...
// If 'isStudent' is true and zip is greater than 8000, then console.log "You're a student on the West Coast!"
// Or else, if 'isStudent' is false or if age is less than 30, then console.log "What are your hobbies?"
// Or else, if 'isStudent' is true, then console.log "Welcome to Prime!"
